package observerPatterns.sentSmsToPhoneNumber;
import java.io.File;
...
public class sentsmstophonenumber {
    public static void main(String[] args) {
        ...
        editor.events.subscribe("save", new EmailNotificationListener("123@example.com"));
        editor.events.subscribe("save", new smssupportlistener("+9230000000","your file has been saved successfully"));
